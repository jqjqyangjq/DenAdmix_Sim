...
def demo_archaic_introgression(
    ...
    pop_params = {
        ...
        "Intro_den_N" : {"id": 5, "Ne": n_archaic_d, "Init": True},
        "ea": {"id": 6, "Ne": n_ea, "Init": True},
        "afr": {"id": 7, "Ne": n_afr, "Init": True },
        "Intro_den_S" : {"id": 8, "Ne": n_archaic_d, "Init": True},
        "Archaic": {"id": 9, "Ne": 10000, "Init": False},
        "Ancestral": {"id": 10, "Ne": 23275, "Init": False}
    }
